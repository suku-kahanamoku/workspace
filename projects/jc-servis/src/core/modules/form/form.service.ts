...
import { VALIDATE_EMAIL, VALIDATE_NAME, VALIDATE_PHONE_NUMBER, VALIDATE_PASSWORD, VALIDATE_PASSWORD_REPEAT, VALIDATE_TIN, VALIDATE_VATID, VALIDATE_ZIP, VALIDATE_STREET, VALIDATE_CITY } from '../../utils/validator.functions';
